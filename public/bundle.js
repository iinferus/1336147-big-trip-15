...
/* harmony import */ var _model_events__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./model/events */ "./src/model/events.js");
...
class Api {
  ...
  getEvents() {
    return this._load({url: 'points'})
      .then(Api.toJSON)
      .then((events) => events.map(_model_events__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient));
  }
  ...
  updateEvent(event) {
    return this._load({
      url: `points/${event.id}`,
      method: Method.PUT,
      body: JSON.stringify(_model_events__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToServer(event)),
      headers: new Headers({'Content-Type': 'application/json'}),
    })
      .then(Api.toJSON)
      .then(_model_events__WEBPACK_IMPORTED_MODULE_0__["default"].adaptToClient);
  }
...
/* harmony import */ var _view_new_event_btn__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./view/new-event-btn */ "./src/view/new-event-btn.js");
/* harmony import */ var _view_filter__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./view/filter */ "./src/view/filter.js");
/* harmony import */ var _presenter_event_bord__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./presenter/event-bord */ "./src/presenter/event-bord.js");
/* harmony import */ var _presenter_trip_info__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./presenter/trip-info */ "./src/presenter/trip-info.js");
/* harmony import */ var _model_events__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./model/events */ "./src/model/events.js");
/* harmony import */ var _utils_render__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./utils/render */ "./src/utils/render.js");
/* harmony import */ var _utils_task__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./utils/task */ "./src/utils/task.js");
/* harmony import */ var _utils_const__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./utils/const */ "./src/utils/const.js");
...
const eventsModel = new _model_events__WEBPACK_IMPORTED_MODULE_5__["default"]();
...
Object(_utils_render__WEBPACK_IMPORTED_MODULE_6__["render"])(tripNav, new _view_site_menu__WEBPACK_IMPORTED_MODULE_0__["default"](), _utils_render__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].AFTERBEGIN);
Object(_utils_render__WEBPACK_IMPORTED_MODULE_6__["render"])(tripMain, new _view_new_event_btn__WEBPACK_IMPORTED_MODULE_1__["default"](), _utils_render__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].BEFOREEND);

const tripInfoPresenter = new _presenter_trip_info__WEBPACK_IMPORTED_MODULE_4__["default"](tripMain, eventsModel);
...
Object(_utils_render__WEBPACK_IMPORTED_MODULE_6__["render"])(tripNav, new _view_filter__WEBPACK_IMPORTED_MODULE_2__["default"](filters, 'all'), _utils_render__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].BEFOREEND);

const boardPresenter = new _presenter_event_bord__WEBPACK_IMPORTED_MODULE_3__["default"](tripEvents, eventsModel, api);
...
api.getDestinations()
  ...
  .then(() => api.getEvents())
  .then((events) => {
    eventsModel.setEvents(_utils_const__WEBPACK_IMPORTED_MODULE_8__["UpdateType"].INIT, events.sort(_utils_task__WEBPACK_IMPORTED_MODULE_7__["sortDay"]));
    tripInfoPresenter.init();
  })
  .catch(() => {
    eventsModel.setEvents(_utils_const__WEBPACK_IMPORTED_MODULE_8__["UpdateType"].INIT, []);
  });
...
class Events extends _utils_abstract_observer__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor() {
    super();
    this._events = [];
    this._offers = [];
  ...
  static adaptToClient(event) {
    const adaptedEvent = Object.assign(
      ...
      event,
      {
        dateFrom: event.date_from !== null ? dayjs__WEBPACK_IMPORTED_MODULE_1___default()(event.date_from) : event.date_from,
        dateTo: event.date_to !== null ? dayjs__WEBPACK_IMPORTED_MODULE_1___default()(event.date_to) : event.date_to,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return EventBoard; });
/* harmony import */ var _view_trip_events__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/trip-events */ "./src/view/trip-events.js");
/* harmony import */ var _view_sort_view__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/sort-view */ "./src/view/sort-view.js");
/* harmony import */ var _event__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./event */ "./src/presenter/event.js");
/* harmony import */ var _event_new__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./event-new */ "./src/presenter/event-new.js");
/* harmony import */ var _view_no_trip__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../view/no-trip */ "./src/view/no-trip.js");
...
class EventBoard {
  constructor(boardContainer, eventsModel, api) {
    ...
    this._listComponent = new _view_trip_events__WEBPACK_IMPORTED_MODULE_0__["default"]();
    this._handleSortTypeChange = this._handleSortTypeChange.bind(this);

    this._eventsModel.addObserver(this._handleModelEvent);
    this._eventNewPresenter = new _event_new__WEBPACK_IMPORTED_MODULE_3__["default"](this._listComponent, this._handleViewAction, this._dataTypes, this._dataDestinations);
  }
  ...
  createTask() {
    this._eventNewPresenter = new _event_new__WEBPACK_IMPORTED_MODULE_3__["default"](this._listComponent, this._handleViewAction, this._dataTypes, this._dataDestinations);
    this._currentSortType = _utils_const__WEBPACK_IMPORTED_MODULE_8__["SortType"].DAY;
    this._eventNewPresenter.init();
  }

  _getEvents() {
    switch (this._currentSortType) {
      case _utils_const__WEBPACK_IMPORTED_MODULE_8__["SortType"].PRICE:
        return this._eventsModel.getEvents().slice().sort(_utils_task__WEBPACK_IMPORTED_MODULE_7__["sortPrice"]);
      case _utils_const__WEBPACK_IMPORTED_MODULE_8__["SortType"].TIME:
        return this._eventsModel.getEvents().slice().sort(_utils_task__WEBPACK_IMPORTED_MODULE_7__["sortDurationTime"]);
    }
    return this._eventsModel.getEvents().slice().sort(_utils_task__WEBPACK_IMPORTED_MODULE_7__["sortDay"]);
  }
  ...
  _renderSort() {
    ...
    this._sortComponent = new _view_sort_view__WEBPACK_IMPORTED_MODULE_1__["default"](this._currentSortType);
    this._sortComponent.setSortTypeChangeHandler(this._handleSortTypeChange);

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_6__["render"])(this._boardContainer, this._sortComponent, _utils_render__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].AFTERBEGIN);
  }

  _handleViewAction(actionType, updateType, update) {
    switch (actionType) {
      case _utils_const__WEBPACK_IMPORTED_MODULE_8__["UserAction"].UPDATE_EVENT:
        this._api.updateEvent(update).then((response) => {
          this._eventsModel.updateEvent(updateType, response);
        });
        break;
      case _utils_const__WEBPACK_IMPORTED_MODULE_8__["UserAction"].ADD_EVENT:
        this._api.addEvent(update).then((response) => {
          this._eventsModel.addEvent(updateType, response);
        });
        break;
      case _utils_const__WEBPACK_IMPORTED_MODULE_8__["UserAction"].DELETE_EVENT:
  ...
  _handleModelEvent(updateType, data) {
    switch (updateType) {
      case _utils_const__WEBPACK_IMPORTED_MODULE_8__["UpdateType"].PATCH:
        this._taskPresenter.get(data.id).init(data);
        break;
      case _utils_const__WEBPACK_IMPORTED_MODULE_8__["UpdateType"].MINOR:
        this._clearBoard();
        this._renderBoard();
        break;
      case _utils_const__WEBPACK_IMPORTED_MODULE_8__["UpdateType"].MAJOR:
        this._clearBoard(true);
        this._renderBoard();
        break;
      case _utils_const__WEBPACK_IMPORTED_MODULE_8__["UpdateType"].INIT:
        this._isLoading = false;
        Object(_utils_render__WEBPACK_IMPORTED_MODULE_6__["remove"])(this._loadingComponent);
        this._dataTypes = this._getOffers();
        this._dataDestinations = this._getDestinations();
        this._renderBoard();
        break;
  ...
  _renderEvent(event) {
    const eventPresenter = new _event__WEBPACK_IMPORTED_MODULE_2__["default"](this._listComponent, this._handleViewAction, this._handleModeChange);
  ...
  _renderLoading() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_6__["render"])(this._boardContainer, this._loadingComponent, _utils_render__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].AFTERBEGIN);
  }

  _renderNoEvent() {
    this._noEventComponent = new _view_no_trip__WEBPACK_IMPORTED_MODULE_4__["default"]();
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_6__["render"])(this._boardContainer, this._noEventComponent, _utils_render__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].BEFOREEND);
  }

  _renderEventsList() {
    this._renderEvents();
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_6__["render"])(this._boardContainer, this._listComponent, _utils_render__WEBPACK_IMPORTED_MODULE_6__["RenderPosition"].BEFOREEND);
  }
  ...
  _clearBoard(resetSortType = false) {
    ...
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_6__["remove"])(this._sortComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_6__["remove"])(this._noEventComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_6__["remove"])(this._loadingComponent);
...
/* harmony import */ var _view_event_edit__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../view/event-edit */ "./src/view/event-edit.js");
...
class EventNew {
  ...
  init() {
    ...
    this._eventEditComponent = new _view_event_edit__WEBPACK_IMPORTED_MODULE_0__["default"](_utils_const__WEBPACK_IMPORTED_MODULE_2__["BLANK_EVENT"], this._dataTypes, this._dataDestinations, true);
    this._eventEditComponent.setFormSubmitHandler(this._handleFormSubmit);
    this._eventEditComponent.setDeleteClickHandler(this._handleDeleteClick);

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_3__["render"])(this._eventListContainer, this._eventEditComponent, _utils_render__WEBPACK_IMPORTED_MODULE_3__["RenderPosition"].AFTERBEGIN);
  ...
  _handleFormSubmit(event) {
    this._changeData(
      _utils_const__WEBPACK_IMPORTED_MODULE_2__["UserAction"].ADD_EVENT,
      _utils_const__WEBPACK_IMPORTED_MODULE_2__["UpdateType"].MAJOR,
      Object.assign({id: Object(nanoid__WEBPACK_IMPORTED_MODULE_1__["nanoid"])()}, event),
    );
    this.destroy();
  }
...
/* harmony import */ var _view_event_edit__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../view/event-edit */ "./src/view/event-edit.js");
...
class Event {
  ...
  init(event, dataTypes, dataDestinations) {
    ...
    this._tripComponent = new _view_event__WEBPACK_IMPORTED_MODULE_0__["default"](event);
    this._tripEditComponent = new _view_event_edit__WEBPACK_IMPORTED_MODULE_1__["default"](this._event, dataTypes, dataDestinations);
    ...
    if (prevTripComponent === null || prevTripEditComponent === null) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(this._eventListContainer, this._tripComponent, _utils_render__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].BEFOREEND);
      return;
    }

    if (this._mode === Mode.DEFAULT) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._tripComponent, prevTripComponent);
    }

    if (this._mode === Mode.EDITING) {
      Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._tripEditComponent, prevTripEditComponent);
    }

    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(prevTripComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(prevTripEditComponent);
  }

  destroy() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._tripComponent);
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._tripEditComponent);
  }
  ...
  _replaceCardToForm() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._tripEditComponent, this._tripComponent);
    document.addEventListener('keydown', this._escKeyDownHandler);
    this._changeMode();
  ...
  _replaceFormToCard() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["replace"])(this._tripComponent, this._tripEditComponent);
    document.removeEventListener('keydown', this._escKeyDownHandler);
    this._mode = Mode.DEFAULT;
  }
  ...
  _handleFavoriteClick() {
    this._changeData(
      _utils_const__WEBPACK_IMPORTED_MODULE_3__["UserAction"].UPDATE_EVENT,
      _utils_const__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].MINOR,
      Object.assign(
        {},
        this._event,
        {
  ...
  _handleDeleteClick(event) {
    this._changeData(
      _utils_const__WEBPACK_IMPORTED_MODULE_3__["UserAction"].DELETE_EVENT,
      _utils_const__WEBPACK_IMPORTED_MODULE_3__["UpdateType"].MINOR,
      event,
    );
  }
...
class TripInfo {
  ...
  _handleModelEvent(updateType) {
    switch (updateType) {
      case _utils_const__WEBPACK_IMPORTED_MODULE_1__["UpdateType"].PATCH:
        break;
      case _utils_const__WEBPACK_IMPORTED_MODULE_1__["UpdateType"].MINOR:
        this._clearInfo();
        this._render();
        break;
      case _utils_const__WEBPACK_IMPORTED_MODULE_1__["UpdateType"].MAJOR:
        this._clearInfo();
        this._render();
        break;
    }
  ...
  _render() {
    this._infoElement = new _view_trip_info__WEBPACK_IMPORTED_MODULE_0__["default"](this._eventsModel.getEvents());
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["render"])(this._container, this._infoElement, _utils_render__WEBPACK_IMPORTED_MODULE_2__["RenderPosition"].AFTERBEGIN);
  }

  _clearInfo() {
    Object(_utils_render__WEBPACK_IMPORTED_MODULE_2__["remove"])(this._infoElement);
  }
...
/*!****************************!*\
  !*** ./src/utils/const.js ***!
  \****************************/
/*! exports provided: SortType, UserAction, UpdateType, BLANK_EVENT, FilterType, MenuItem */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const BLANK_EVENT = {
  basePrice: 0,
  dateFrom: dayjs__WEBPACK_IMPORTED_MODULE_0___default()(),
  dateTo: dayjs__WEBPACK_IMPORTED_MODULE_0___default()().add(1, 'day'),
  destination: {
    name: '',
    description: '',
    pictures: [],
...
/*!*****************************!*\
  !*** ./src/utils/render.js ***!
  \*****************************/
/*! exports provided: RenderPosition, remove, render, createElement, createListElement, replace, updateItem */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createElement", function() { return createElement; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "createListElement", function() { return createListElement; });
...
/*!***************************!*\
  !*** ./src/utils/task.js ***!
  \***************************/
/*! exports provided: sortDay, sortPrice, sortDurationTime, isEventExpired, isEventUpcoming */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortDay", function() { return sortDay; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortPrice", function() { return sortPrice; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "sortDurationTime", function() { return sortDurationTime; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isEventExpired", function() { return isEventExpired; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isEventUpcoming", function() { return isEventUpcoming; });
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! dayjs */ "./node_modules/dayjs/dayjs.min.js");
/* harmony import */ var dayjs__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(dayjs__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var dayjs_plugin_duration_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! dayjs/plugin/duration.js */ "./node_modules/dayjs/plugin/duration.js");
/* harmony import */ var dayjs_plugin_duration_js__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(dayjs_plugin_duration_js__WEBPACK_IMPORTED_MODULE_1__);


dayjs__WEBPACK_IMPORTED_MODULE_0___default.a.extend(dayjs_plugin_duration_js__WEBPACK_IMPORTED_MODULE_1___default.a);
...
const sortDay = (taskA, taskB) => {
  ...
  return dayjs__WEBPACK_IMPORTED_MODULE_0___default()(taskA.dateFrom).diff(dayjs__WEBPACK_IMPORTED_MODULE_0___default()(taskB.dateFrom));
};
...
const isEventExpired = (date) => dayjs__WEBPACK_IMPORTED_MODULE_0___default()().isAfter(date, 'D');

const isEventUpcoming = (date) => dayjs__WEBPACK_IMPORTED_MODULE_0___default()().isBefore(date, 'D');
...
/*!****************************!*\
  !*** ./src/utils/utils.js ***!
  \****************************/
/*! exports provided: getRandomInteger, getRandomArrayElement, getRandomMultipleArrayElement, getDurationDates, delay */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getRandomMultipleArrayElement", function() { return getRandomMultipleArrayElement; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getDurationDates", function() { return getDurationDates; });
...
/* harmony import */ var dayjs_plugin_minMax_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! dayjs/plugin/minMax.js */ "./node_modules/dayjs/plugin/minMax.js");
/* harmony import */ var dayjs_plugin_minMax_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(dayjs_plugin_minMax_js__WEBPACK_IMPORTED_MODULE_2__);
...
dayjs__WEBPACK_IMPORTED_MODULE_0___default.a.extend(dayjs_plugin_utc_js__WEBPACK_IMPORTED_MODULE_1___default.a);
dayjs__WEBPACK_IMPORTED_MODULE_0___default.a.extend(dayjs_plugin_minMax_js__WEBPACK_IMPORTED_MODULE_2___default.a);
dayjs__WEBPACK_IMPORTED_MODULE_0___default.a.extend(dayjs_plugin_duration_js__WEBPACK_IMPORTED_MODULE_3___default.a);
...
const getDurationDates = (dateStart, dateFinish) => {
  ...
  const daysCount = dayjs__WEBPACK_IMPORTED_MODULE_0___default.a.duration(diff).format('DD');
  const hoursCount = dayjs__WEBPACK_IMPORTED_MODULE_0___default.a.duration(diff).format('HH');
  const minutesCount = dayjs__WEBPACK_IMPORTED_MODULE_0___default.a.duration(diff).format('mm');
...
const getOffers = (dataPoint, dataTypes, isCreate) => {
  let offersTemplate = '';
  const checkedOffers = [];
    ...
    if(element.type === dataPoint.type) {
      element.offers.forEach((offer) => offersTemplate += `
        <div class="event__offer-selector">
          <input class="event__offer-checkbox  visually-hidden" id="event-offer${isCreate ? '' : `-${dataPoint.id}`}-${offer.title.split(' ').join('-')}" type="checkbox" name="event-offer${isCreate ? '' : `-${dataPoint.id}`}-${offer.title.split(' ').join('-')}" ${checkedOffers.indexOf(offer.title) !== -1 ? 'checked' : ''} data-title="${offer.title}" data-price="${offer.price}">
...
const createEventForm = (
  ...
  const {id, type, dateFrom, dateTo, basePrice, destination} = dataPoint;
  ...
  <header class="event__header">
    ...
    <div class="event__field-group  event__field-group--destination">
      ...
      <input class="event__input  event__input--destination" id="event-destination-${isCreate ? '' : `-${id}`}" type="text" name="event-destination" value="${destinationName}" autocomplete="on" list="destination-list${isCreate ? '' : `-${id}`}">
    ...
    <div class="event__field-group  event__field-group--time">
      ...
      <input class="event__input  event__input--time" id="event-start-time-${id}" type="text" name="event-start-time" value="${dateFrom.format('DD/MM/YY HH:mm')}">
      &mdash;
      <label class="visually-hidden" for="event-end-time-${id}">To</label>
      <input class="event__input  event__input--time" id="event-end-time-${id}" type="text" name="event-end-time" value="${dateTo.format('DD/MM/YY HH:mm')}">
    </div>
    ...
    <div class="event__field-group  event__field-group--price">
      ...
      <input class="event__input  event__input--price" id="event-price-${isCreate ? '' : `-${id}`}" type="number" name="event-price" value="${basePrice}">
    </div>

    <button class="event__save-btn  btn  btn--blue" type="submit"${destinationName !== '' ? '' : 'disabled'}>Save</button>
  ...
  <section class="event__details">
    ...
    `<section class="event__section  event__section--offers">
      ...
      <div class="event__available-offers">
          ${getOffers(dataPoint, dataTypes, isCreate)}
      </div>
    </section>` : '' }
...
class EventForm extends _smart__WEBPACK_IMPORTED_MODULE_0__["default"] {
  constructor(event, dataTypes, dataDestinations, isCreate = false) {
    ...
    this._dataTypes = dataTypes;
    this._dataDestinations = dataDestinations;
    this._data = EventForm.parseEventToData(this._event, this._dataDestinations, this._dataTypes);
  ...
  _setDatepicker() {
    ...
    this._datepickerStart = Object(flatpickr__WEBPACK_IMPORTED_MODULE_2__["default"])(
    ...
    this._datepickerEnd = Object(flatpickr__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _dateFromChangeHandler([userDate]) {
    this.updateData({
      dateFrom: dayjs__WEBPACK_IMPORTED_MODULE_1___default()(userDate),
    });
  }

  _dateToChangeHandler([userDate]) {
    this.updateData({
      dateTo: dayjs__WEBPACK_IMPORTED_MODULE_1___default()(userDate),
    });
  }
  ...
  static parseEventToData(event, dataDestinations) {
    return Object.assign(
      {},
      event,
      {
        isOffers: event.offers !== null,
        isDestination: dataDestinations.forEach((dataDestination) => dataDestination.name === event.destination.name),
      },
    );
  }
...
<div class="event">
  ...
  <div class="event__schedule">
    ...
    <p class="event__duration">${Object(_utils_utils__WEBPACK_IMPORTED_MODULE_0__["getDurationDates"])(dateFrom, dateTo)}</p>
  </div>
...
class TripEvent extends _abstract__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor(trip) {
    super();
    this._trip = trip;
...
class NewEventButton extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _menuClickHandler(evt) {
    evt.preventDefault();
    this._callback.menuClick(_utils_const__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].ADD_NEW_EVENT);
  }
}
...
class TripFilter extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
  getTemplate() {
...
const createSiteMenuTemplate = () => (
  `<div class="trip-controls__navigation">
    ...
    <a class="trip-tabs__btn  trip-tabs__btn--active" data-menu-item-name="${_utils_const__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].TABLE}" href="#">Table</a>
    <a class="trip-tabs__btn" data-menu-item-name="${_utils_const__WEBPACK_IMPORTED_MODULE_1__["MenuItem"].STATS}" href="#">Stats</a>
  </nav>
  </div>`
);
...
const createSortsRadio = (currentSortType) => {
  let sortsTemplate = '';
  for (const value of Object.values(_utils_const__WEBPACK_IMPORTED_MODULE_1__["SortType"])) {
    sortsTemplate += `
...
class TripSort extends _abstract__WEBPACK_IMPORTED_MODULE_0__["default"] {
